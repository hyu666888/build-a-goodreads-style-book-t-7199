...
export function BookModal({ book, state, onShelfChange, onRatingChange, onClose }: BookModalProps) {
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      {/* Modal panel */}
      <div className="relative w-full sm:max-w-lg bg-cream rounded-t-2xl sm:rounded-2xl shadow-2xl overflow-hidden">
        {/* Close button */}
        <button
          onClick={onClose}
